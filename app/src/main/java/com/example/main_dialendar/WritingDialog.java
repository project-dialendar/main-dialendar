...
public class WritingDialog extends AppCompatActivity {
    ...
    public void callFunction(final TextView main_label){
        ...
        // 커스텀 다이얼로그의 각 위젯 정의
        tv_date = (TextView) findViewById(R.id.tv_date_writing);
        btn_options = (ImageButton) findViewById(R.id.btn_writing_options);
        btn_photo = (ImageButton) findViewById(R.id.btn_photo);
        et_writing = (EditText) findViewById(R.id.et_writing_text);
