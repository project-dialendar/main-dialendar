...
import com.apps.main_dialendar.model.Day;
import com.apps.main_dialendar.R;
import com.apps.main_dialendar.view.adapter.CalendarAdapter;
import com.apps.main_dialendar.view.adapter.WeekAdapter;
import com.apps.main_dialendar.view.dialog.BackupDialog;
import com.apps.main_dialendar.view.dialog.YearPickerDialog;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case (R.id.setting):
                        ...
                        break;
                    case (R.id.backup):
                        Toast.makeText(MainActivity.this, "준비 중입니다.", Toast.LENGTH_LONG).show();
